...
# You don't need to, though if you don't, the file will be made in /someotherpath/here & file locations ect will be mixed up...
##############################
# $iv will be given to the user as an additional key. unlike $key, $iv is basically a "key" to get the true $IV which is encrypted in the encrypted file to decrypt the decrypted file. - Say what?
##############################
